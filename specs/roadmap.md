...
| ID  | Feature | Description | Status | Depends on | Issues |
|-----|---------|-------------|--------|------------|--------|
| 007 | config-builder-routing | CRUD for routing tree via guided forms + YAML preview | [~] | 006 | #50 |
...
| 010 | auth-rbac-fixes | Fix default role bug, login UX, role validation at startup | [~] | 006 | #87 #88 #89 #90 #91 #92 |
